...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/DSCore/DSCore.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/RemoteAssets/RemoteAssets.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/TabBarHome/TabBarHome.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/WeathyLogin/WeathyLogin.framework"
